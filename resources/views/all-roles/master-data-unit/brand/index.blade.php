        ...
        <div class="col-lg-12 d-flex align-items-stretch">
            <div class="card w-100">
                <div class="card-body p-4">
                    <div class="row mb-4">
                        <div class="col-6">
                            <h5 class="card-title fw-semibold">Master Data Brand</h5>
                        </div>
                            ...
                            <tbody>
                                @forelse ($brand as $data)
                                    <tr>
                                        ...
                                        <td class="border-bottom-0">
                                            <h6 class="fw-semibold mb-1">{{ $data->name_brand }}</h6>
                                        </td>
                                        <td class="border-bottom-0 d-flex gap-1">
                                            <a href="{{ route('brand.edit', $data->id) }}" class="btn btn-warning"><i
