        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('uom.update', $data->id) }}" method="POST">
                                @csrf
                                @method('put')
                                <div class="mb-3">
                                    <label for="unit" class="form-label">unit</label>
                                    <input type="text" class="form-control" id="unit" name="unit" required
                                        placeholder="masukkan unit" value="{{ $data->unit }}" aria-describedby="unitHelp">
                                    @error('unit')
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="desc" name="desc" required
                                        placeholder="masukkan desc" value="{{ $data->desc }}" aria-describedby="descHelp">
                                    @error('desc')
