...
@section('main')
    <div class="container-fluid">
        <div class="container-fluid">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title fw-semibold mb-4">Create Master Data Barang</h5>
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('dashboard.master-data-barang.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="serial_number" name="serial_number" required
                                        placeholder="masukkan serial number" value="{{ old('serial_number') }}" aria-describedby="serialNumberHelp">
                                    @error('serial_number')
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="item_name" name="item_name" required
                                        placeholder="masukkan nama barang" value="{{ old('item_name') }}" aria-describedby="itemNameHelp">
                                    @error('itemNameHelp')
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="price" name="price" required
                                        placeholder="masukkan harga" value="{{ old('price') }}" aria-describedby="priceHelp">
                                    @error('priceHelp')
