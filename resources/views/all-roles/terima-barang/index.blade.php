        ...
        <div class="col-lg-12 d-flex align-items-stretch">
            <div class="card w-100">
                <div class="card-body p-4">
                    <div class="row mb-4">
                        <div class="col-6">
                            <h5 class="card-title fw-semibold">Terima Barang</h5>
                        </div>
                        <div class="col-6 text-end">
                            <a href="{{route('dashboard.terima-barang.create')}}" class="btn btn-success ">Create</a>
                        </div>
                    </div>
                    <div>
                            ...
                            <tbody>
                                @forelse ($data as $recieve_item)
                                    <tr>
                                        ...
                                        <td class="border-bottom-0">
                                            <h6 class="fw-semibold mb-1">{{ $recieve_item->created_at->diffForHumans() }}</h6>
                                        </td>
                                        <td class="border-bottom-0">
